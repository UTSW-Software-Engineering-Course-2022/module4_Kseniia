...
int main(int argc, char* argv[])
{
    ...
    // Load reference from fasta file
    {
        ...
        FReference ref("/Users/kdudnyk/Downloads/SEClass-main/Example_Files/small.fa"); // load fasta file
        ...
        queryVector = LoadQueryFromFasta("/Users/kdudnyk/Downloads/SEClass-main/Example_Files/small_reads.fa");
        ...
        while (i < nq)
        {
            ...
            search(query, txt, suffixArr, n, "/Users/kdudnyk/Downloads/query_allign.txt", i);
            i = i+1;
